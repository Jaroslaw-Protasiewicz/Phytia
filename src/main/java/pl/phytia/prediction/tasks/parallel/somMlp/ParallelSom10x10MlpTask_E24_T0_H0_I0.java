 ...
 */
public class ParallelSom10x10MlpTask_E24_T0_H0_I0 extends
	...
	static {
		try {
			dateStart = Localization.plDateFormatMedium.parse("2004-09-17");
			dateStop = Localization.plDateFormatMedium.parse("2004-10-01");
			dateStartTrain = Localization.plDateFormatMedium
					.parse("2002-01-08");
			dateStopTrain = Localization.plDateFormatMedium.parse("2004-09-16");
	...
	public static void doIt() throws Exception {
		ParallelSom10x10MlpTask_E24_T0_H0_I0 task = new ParallelSom10x10MlpTask_E24_T0_H0_I0();
		MetaModelConfiguration conf = new MetaModelConfiguration();
		conf.setForcastType(EnumForecastType.E24_T0_H0_I0);
		conf.setInputSignal(EnumSignalType.MODELLING_DATA_NORMALIZED);
		conf.setOutputSignal(Tools.getForecastName(
				EnumMetaModelType.PARALLEL_SOM_10x10_MLP,
				EnumForecastType.E24_T0_H0_I0));
		conf.setMetamodelType(EnumMetaModelType.PARALLEL_SOM_10x10_MLP);
		...
		// task.preparation();
		task.prediction();
		// task.testClasses(EnumForecastType.E24_T0_H0_I0.toString(),
		// EnumMetaModelType.PARALLEL_SOM_10x10_MLP.toString(),
		// dateStartTrain, dateStopTrain,"");
	}
