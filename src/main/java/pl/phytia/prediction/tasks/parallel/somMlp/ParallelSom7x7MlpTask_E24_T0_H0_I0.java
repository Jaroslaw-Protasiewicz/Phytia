 ...
 */
public class ParallelSom7x7MlpTask_E24_T0_H0_I0 extends ParallelSomMlpMetaModel {
	...
	public static void doIt() throws Exception {
		...
		ParallelSom7x7MlpTask_E24_T0_H0_I0 task = new ParallelSom7x7MlpTask_E24_T0_H0_I0();
		...
		conf.setOutputSignal(Tools.getForecastName(
				EnumMetaModelType.PARALLEL_SOM_7x7_MLP,
				EnumForecastType.E24_T0_H0_I0));
		conf.setMetamodelType(EnumMetaModelType.PARALLEL_SOM_7x7_MLP);
		...
		task.testClasses(EnumForecastType.E24_T0_H0_I0.toString(),
				EnumMetaModelType.PARALLEL_SOM_7x7_MLP.toString(),
				dateStartTrain, dateStopTrain, "e:\\tmp\\" + "SomClasses"
						+ EnumMetaModelType.PARALLEL_SOM_7x7_MLP.toString()
						+ "_" + EnumForecastType.E24_T0_H0_I0.toString()
						+ ".xls");
	}
