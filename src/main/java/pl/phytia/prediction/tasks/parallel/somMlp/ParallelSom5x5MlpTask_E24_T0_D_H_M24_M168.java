 ...
 */
public class ParallelSom5x5MlpTask_E24_T0_D_H_M24_M168 extends
	...
	public static void doIt() throws Exception {
		ParallelSom5x5MlpTask_E24_T0_D_H_M24_M168 task = new ParallelSom5x5MlpTask_E24_T0_D_H_M24_M168();
		MetaModelConfiguration conf = new MetaModelConfiguration();
		conf.setForcastType(EnumForecastType.E24_T0_D_H_M24_M168);
		...
		// task.preparation();
		// task.prediction();
		task.testClasses(EnumForecastType.E24_T0_D_H_M24_M168.toString(),
				EnumMetaModelType.PARALLEL_SOM_5x5_MLP.toString(),
				dateStartTrain, dateStopTrain, "e:\\tmp\\25-"
						+ Tools.getForecastName(
								EnumMetaModelType.PARALLEL_SOM_5x5_MLP,
								EnumForecastType.E24_T0_D_H_M24_M168) + ".xls");
	}
