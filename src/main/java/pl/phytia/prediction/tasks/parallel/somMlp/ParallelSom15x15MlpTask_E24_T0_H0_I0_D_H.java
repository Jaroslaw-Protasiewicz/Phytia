 ...
 */
public class ParallelSom15x15MlpTask_E24_T0_H0_I0_D_H extends
	...
	static {
		try {
			dateStart = Localization.plDateFormatMedium.parse("2004-10-31");
			dateStop = Localization.plDateFormatMedium.parse("2004-11-30");
			dateStartTrain = Localization.plDateFormatMedium
					.parse("2002-01-01");
			dateStopTrain = Localization.plDateFormatMedium.parse("2002-01-30");
	...
	public static void doIt() throws Exception {
		ParallelSom15x15MlpTask_E24_T0_H0_I0_D_H task = new ParallelSom15x15MlpTask_E24_T0_H0_I0_D_H();
		...
		conf.setOutputSignal(Tools.getForecastName(
				EnumMetaModelType.PARALLEL_SOM_15x15_MLP,
		...
		task.testClasses(EnumForecastType.E24_T0_H0_I0_D_H.toString(),
				EnumMetaModelType.PARALLEL_SOM_15x15_MLP.toString(),
