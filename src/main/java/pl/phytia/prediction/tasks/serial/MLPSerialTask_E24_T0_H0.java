 ...
 * parametrów: energia, temperatura, wligotność.
 * 
 * @author Jarosław Protasiewicz
 */
public class MLPSerialTask_E24_T0_H0 extends MLPSerialMetaModel {
	...
	public static void doIt() {
		...
		MetaModel<MLPModel> task = new MLPSerialTask_E24_T0_H0();
		MetaModelConfiguration confMetaModel = new MetaModelConfiguration(
				EnumMetaModelType.SERIAL_MLP, EnumForecastType.E24_T0_H0, 7,
	...
	protected AnnModelConfiguration preparePredictorConfiguration() {
		AnnModelConfiguration conf = new AnnModelConfiguration(
				EnumNetworkType.MLP, 1, 1, 0, 24, -15, 15, -2, 24, 0.1, null,
				null, false, false);
		return conf;
	}
