...
public class QuickProp4Task extends QuickProp2Task {
	public static void doIt() throws Exception {
		String kom = null;
		String path = "E:\\home\\phd\\QuickProp\\";

		QuickProp4Task task = new QuickProp4Task();
		...
		for (int k = 0; k < maximumGrowthRatio.length; ++k) {
			StringBuilder fileName = new StringBuilder("QuickProp4Task");
			if (k < 10) {
